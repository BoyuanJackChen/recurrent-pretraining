...
def main():
    ...
    for r in all_r:
        result_df = pd.read_csv(f"../../outputs/{keyword}_harmbench/{keyword}_r{r}.csv")
        print(result_df)
    ...
    # Show the plot and save to ../plots/{keyword}_jb_r.png, with dpi=500
    plt.show()
    fig.savefig(f"../../outputs/{keyword}_harmbench/{keyword}_jb_r.png", dpi=500)
